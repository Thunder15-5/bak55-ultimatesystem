    ...
    extend: {
      ...
      colors: {
        ...
        luxury: {
          ...
          'glass-hover-dark': 'rgba(0, 0, 0, 0.16)',
        },
      },
      ...
      /* -----------------------------------
         🧱 ENHANCED BORDER RADIUS & SPACING
      ----------------------------------- */
      borderRadius: {
        'sm': '4px',
        'DEFAULT': '6px',
      ...
      boxShadow: {
        ...
        'luxury-lg': '0 16px 48px rgba(0, 0, 0, 0.42)',
        'glow-primary': '0 0 25px rgba(139, 92, 246, 0.5)',
        'glow-secondary': '0 0 25px rgba(6, 214, 160, 0.4)',
        'glow-accent': '0 0 25px rgba(255, 209, 102, 0.4)',
        'inner': 'inset 0 2px 4px 0 rgb(0 0 0 / 0.05)',
      },

      /* -----------------------------------
         🎞️ ENHANCED ANIMATIONS & TRANSITIONS
      ----------------------------------- */
      animation: {
        ...
        'scale-out': 'scaleOut 0.25s ease-in',
      ...
      backgroundImage: {
        ...
        'gradient-luxury': 'linear-gradient(135deg, #8b5cf6 0%, #06d6a0 50%, #ffd166 100%)',
