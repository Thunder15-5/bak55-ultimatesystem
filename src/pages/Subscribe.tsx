          ...
          <div className="max-w-3xl mx-auto mt-16">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  BAKCoins are our platform currency. You can buy them via M-Pesa and use them for subscriptions, competition entries, and tipping artists. They're stored in your wallet and can be withdrawn anytime.
                </AccordionContent>
              </AccordionItem>
