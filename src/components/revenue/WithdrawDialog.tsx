  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${net.toFixed(2)} BAK queued · Ref ${data?.reference ?? "pending"}. ETA 24–72h.`,
      });
      ...
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Withdraw BAKCoins to your M-Pesa. 5% network fee · ETA 24–72h.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 py-1">
            ...
            <div className="space-y-2">
              <div className="space-y-1">
                ...
                <Input id="phone" inputMode="tel" placeholder="2547XXXXXXXX"
                  value={phone} onChange={(e) => setPhone(e.target.value)} />
              </div>
              <div className="space-y-1">
                <Label htmlFor="name" className="text-xs">Account name</Label>
                <Input id="name" placeholder="As on M-Pesa"
