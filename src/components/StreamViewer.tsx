...
import { Send, Users, Coins, Radio, Heart } from "lucide-react";
              ...
              {isLive ? (
                <>
                  ...
                  <div className="text-center text-muted-foreground">
                    ...
                    <p className="text-lg font-medium">Live Audio Stream</p>
                    <p className="text-sm">Streaming infrastructure coming soon</p>
                  </div>
                </>
              ) : (
                <div className="text-center text-muted-foreground">
      ...
      <Card className="bg-card/50 border-border/50 flex flex-col h-[600px]">
        ...
        <ScrollArea className="flex-1 p-4" ref={scrollRef as any}>
          <div className="space-y-3">
            ...
            {messages.map(msg => (
              <div key={msg.id} className={`text-sm ${msg.is_tip ? "bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-2" : ""}`}>
